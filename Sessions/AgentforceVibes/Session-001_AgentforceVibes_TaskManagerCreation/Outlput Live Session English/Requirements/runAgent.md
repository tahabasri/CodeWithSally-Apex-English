...
2. **Phase 1:** Create the UI prototype (mock data only).
3. **Phase 2:** Add the Apex controller and logic.
4. **Phase 3:** Write test classes.
5. **Phase 4:** Add or verify the demo script file under `/scripts`.
6. **Phase 5:** Connect LWC to Apex, clean up, and finalize with toast messages and comments.
